...
export const siteConfig: SiteConfig = {
	title: "Asround",
	subtitle: "桂香尘处减，练影月前空。",
	siteURL: "https://asround-blog-ctourhp9.edgeone.cool/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-08", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			title: "Asround", // 主页横幅主标题

			subtitle: [
				"杯子碰到一起，不是梦破碎的声音",
				"但愿我生产愿望的能力，胜于我实现愿望的能力",
	...
	favicon: [
		// 留空以使用默认 favicon
		{
			src: "/favicon/favicon-dark.svg", // 图标文件路径
			theme: "dark", // 可选，指定主题 'light' | 'dark'
			sizes: "32x32", // 可选，图标大小
		},
		{
			src: "/favicon/favicon-light.svg", // 图标文件路径
	...
	font: {
		...
		asciiFont: {
			...
			fontWeight: "400",
			localFonts: ["TikTokSans-VariableFont_opsz,slnt,wdth,wght.ttf"],
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	...
	opacity: 0.1, // 壁纸透明度, 0.01几乎不可见, 0和1效果相同, 清晰度高
	blur: 0, // 背景模糊程度 (0为不模糊, 数值越大模糊程度越高, 10已较模糊)
};
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Asround",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/396602889",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/malenia.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Asround",
	bio: "桂香尘处减，练影月前空。",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎阅读我的博客，希望这里有对你有价值的东西！", // 公告内容
...
// 歌单链接: https://music.163.com/#/playlist?id=17742058095
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	components: {
		...
		right: [], // 右侧边栏暂不启用, 将更多内容留给正文展示，避免过于拥挤
